...
class Model_List extends Model
{
    ...
    *
    * @param string ーにしたいカラム名 $key
    * @param string 順序 $order
    * @return array(string => string) 用語一覧データ $query->execute()->as_array()
    */
    ...
    * 用語名と略語に対して完全一致検索を行う
    *
    * @param string 検索ワード $word
    * @return array(string => string) 検索結果 $query->execute()->as_array()
    */
